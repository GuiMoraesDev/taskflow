...
| **Chat-narrative leak**                 | "as requested", "as we discussed", "let's", pasted prompt text; "previously X now Y", "no longer used", "an earlier rule said". Also any reference to a gitignored working doc - "see PLAN.md", "TASK-3" - in code, comments, commit messages or test names                                                                                   |
